...
public class ServletMostrarCocinero extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ResultSet lista_cocineros = DaoCocinero.mostrarCocinero();
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            while (lista_cocineros.next()) {
                out.println("<p>" + lista_cocineros.getString("idCocinero") + "</p>");
                out.println("<p>" + lista_cocineros.getString("nombre") + " " + lista_cocineros.getString("apellido") + "</p>");
                out.println("<p>" + lista_cocineros.getString("especialidad") + "</p>");
                out.println("<p>---------------------------------------------------------------</p>");
                //out.println("<br/>");
            }
            out.println("</body>");
